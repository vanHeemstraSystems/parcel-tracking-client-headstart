...
Let's add our socket service to the separate docker-compose file in production called ***sample.docker-compose.prod.yml***.
...
CMD ["npm", "start"]
```
containers/app/socket/Dockerfile.prod
